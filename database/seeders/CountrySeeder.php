...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $countries = array("México", "Afganistán", "Albania", "Alemania", "Andorra", "Angola", "Antigua y Barbuda",
            ...
            "Mauritania", "Micronesia", "Moldavia", "Mónaco", "Mongolia", "Montenegro", "Mozambique", "Namibia", "Nauru", "Nepal",
            ...
            "República de Macedonia", "República del Congo", "República Democrática del Congo", "República Dominicana",
            "República Sudafricana", "Ruanda", "Rumanía", "Rusia", "Samoa", "San Cristóbal y Nieves", "San Marino",
